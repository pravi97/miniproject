...
from sis.models import get_default_language, GradeLevel, SchoolYear, Faculty
...
class Applicant(models.Model, CustomFieldModel):
    ...
    state = models.CharField(max_length=360, blank=True)
    ...
    parent_guardians = models.ManyToManyField('sis.EmergencyContact', verbose_name="Student contact", blank=True)
