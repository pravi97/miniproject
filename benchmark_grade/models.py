...
if not 'benchmarks' in settings.INSTALLED_APPS:
...
class CalculationRulePerCourseCategory(models.Model):
    ...
    apply_to_departments = models.ManyToManyField('schedule.Department', blank=True)
...
class CalculationRuleCategoryAsCourse(models.Model):
    ...
    '''
    category = models.ForeignKey('Category')
    include_departments = models.ManyToManyField('schedule.Department', blank=True)
