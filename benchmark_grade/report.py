...
from sis.models import SchoolYear, Student
from work_study.models import StudentWorker
from sis.uno_report import uno_save
from schedule.models import MarkingPeriod, CourseSection
from grades.models import StudentMarkingPeriodGrade
from benchmark_grade.models import (
    Category, Item, Aggregate, Demonstration, CalculationRulePerCourseCategory)
from benchmark_grade.utility import benchmark_find_calculation_rule, gradebook_get_average
from benchmark_grade.views import gradebook
...
def student_incomplete_course_sections(request):
    ...
    for student in students:
        ...
        narrative = []
        course_section_details = sorted(course_section_details.items())
