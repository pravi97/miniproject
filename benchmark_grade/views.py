...
from sis.models import SchoolYear, Student, Faculty
from schedule.models import CourseSection, MarkingPeriod
from grades.models import Grade
from grades.forms import GradeUpload
from administration.models import Configuration
from benchmark_grade.models import Category, Mark, Aggregate, Item, Demonstration, CalculationRule, AggregateTask, CalculationRulePerCourseCategory
from benchmark_grade.forms import GradebookFilterForm, ItemForm, DemonstrationForm, FillAllForm
from benchmarks.models import Benchmark
from benchmark_grade.utility import gradebook_get_average, gradebook_get_average_and_pk, gradebook_recalculate_on_item_change, gradebook_recalculate_on_mark_change
from benchmark_grade.utility import benchmark_find_calculation_rule
...
def comments(request, course_section_id):
    ...
    for marking_period in reverse_lazyd(marking_periods):
