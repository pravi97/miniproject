...
from benchmark_grade.models import Category, Item, Demonstration, Mark, Aggregate
from benchmark_grade.models import CalculationRulePerCourseCategory, CalculationRuleCategoryAsCourse, CalculationRuleSubstitution, CalculationRule, AssignmentType
