...
from schedule.models import Course, CourseSection, MarkingPeriod
from schedule.forms import EngradeSyncForm
from sis.models import Student, UserPreference, Faculty, SchoolYear
from sis.helper_functions import Struct
from sis.uno_report import replace_spreadsheet
...
def teacher_grade(request):
    ...
    if "engrade_sync" in settings.INSTALLED_APPS:
        if request.method == 'POST':
            ...
            if form.is_valid():
                try:
                    from engrade_sync.engrade_sync import EngradeSync
