from work_study.models import (StudentWorker, TimeSheet, Contact,
        TimeSheetPerformanceChoice, ClientVisit, WorkTeam, CompContract,
        Attendance)
from sis.forms import StudentReportWriterForm
...
class ReportTemplateForm(StudentReportWriterForm):
    ...
    date_end = None
    try:
        student = al.MultipleChoiceField('StudentUserAutocomplete', required=False)
