...
from sis.models import StudentNumber
from sis.helper_functions import get_base_url
from sis.admin import StudentFileInline
...
class StudentInteractionAdmin(admin.ModelAdmin):
    ...
    def save_model(self, request, obj, form, change):
        ...
        try:
            ...
            print("could not send CRA email", end="", file=sys.stderr)
...
class ContactAdmin(admin.ModelAdmin):
    def render_change_form(self, request, context, *args, **kwargs):
        try:
            ...
            print("contact admin error, probably from making new one", end="", file=sys.stderr)
