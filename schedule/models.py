...
from sis.models import Student, GradeScaleRule
from sis.helper_functions import round_as_decimal, round_to_standard
...
class MarkingPeriod(models.Model):
    ...
    def save(self, **kwargs):
        ...
        if 'grades' in settings.INSTALLED_APPS:
            from grades.tasks import build_grade_cache
