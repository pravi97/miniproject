...
from sis.models import (Student, StudentNumber, EmergencyContactNumber, TranscriptNote,
...
from schedule.models import AwardStudent, MarkingPeriod, CourseEnrollment, CourseSection
