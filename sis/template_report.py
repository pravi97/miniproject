...
from sis.models import SchoolYear, UserPreference
from sis.helper_functions import strip_unicode_to_ascii
...
class TemplateReport(object):
    ...
    def pod_save(self, template, ext=None, get_tmp_file=False):
        ...
        wrapper = FileWrapper(open(file_name)) # notice not using the tmp file! Not ideal.
