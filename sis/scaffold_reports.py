...
from administration.models import Template, Configuration
from sis.models import Student, SchoolYear, GradeLevel, Faculty, Cohort
from attendance.models import CourseSectionAttendance, StudentAttendance, AttendanceStatus
from schedule.calendar import Calendar
from schedule.models import MarkingPeriod, Department, CourseMeet, Period, CourseSection, Course, CourseSectionTeacher, CourseEnrollment
from grades.models import Grade
from discipline.models import DisciplineAction, DisciplineActionInstance
...
class SelectSpecificStudentsForm(forms.Form):
    try:
        select_students = al.MultipleChoiceField('StudentUserAutocomplete', required=False)
...
class SelectSpecificStudents(ModelMultipleChoiceFilter):
    ...
    def build_form(self):
        ...
        self.form.fields['select_students'] = al.ModelMultipleChoiceField('StudentUserAutocomplete', required=False)
