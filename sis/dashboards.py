...
from discipline.dashboards import DisciplineDashlet
from schedule.models import Course, MarkingPeriod, CourseSection
from .models import SchoolYear
from attendance.models import StudentAttendance, CourseSectionAttendance, AttendanceStatus, AttendanceLog
from report_builder.models import Report
import datetime

from django.core.urlresolvers import reverse_lazy
from responsive_dashboard.dashboard import AdminListDashlet, LinksListDashlet, dashboards
from sis.models import Student, UserPreference, Faculty
    ...
    links = [
        {
            ...
            'link': reverse_lazy('attendance.views.teacher_attendance'),
            'perm': ('attendance.take_studentattendance',),
        },
        {
            'text': 'Take course section attendance',
            'link': reverse_lazy('attendance.views.select_course_section_for_attendance'),
            'perm': ('attendance.take_studentattendance',),
        },
        {
            'text': 'Reports',
            'link': reverse_lazy('attendance.views.attendance_report'),
            'perm': ('sis.reports',),
        },
    ]
