...
from sis.dashboards import ReportBuilderDashlet
...
# Don't freak the fuck out when reverse_lazy fails
try:
    annoying_link = reverse_lazy('engrade_sync.views.setup')
except:
    annoying_link = ""
class AdministrationLinksListDashlet(LinksListDashlet):
    links = [
        {
            'text': 'School Import',
            'link': reverse_lazy('simple_import.views.start_import'),
            'desc': '',
            'perm': ('simple_import.change_importlog',),
        },
                {
            'text': 'Configuration',
            'link': reverse_lazy('admin:administration_configuration_changelist'),
            'desc': '',
            'perm': ('administration.change_configuration',),
        },
        {
            'text': 'Custom Fields',
            'link': reverse_lazy('admin:custom_field_customfield_changelist'),
            'desc': '',
